...
class InvoiceHeadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_header" do
    assert_difference('InvoiceHeader.count') do
      post invoice_headers_url, params: { invoice_header: { Customer: @invoice_header.Customer, InvoiceDateTime: @invoice_header.InvoiceDateTime, State: @invoice_header.State } }
    end
  ...
  test "should update invoice_header" do
    patch invoice_header_url(@invoice_header), params: { invoice_header: { Customer: @invoice_header.Customer, InvoiceDateTime: @invoice_header.InvoiceDateTime, State: @invoice_header.State } }
